  ...
  return (
    <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',background:'var(--bg)',textAlign:'center'}}>
      <div>
        ...
        <Link href="/" style={{padding:'11px 24px',borderRadius:'10px',fontSize:'14px',fontWeight:700,color:'#04120c',background:'var(--teal)',textDecoration:'none',boxShadow:'0 0 20px var(--teal-glow)'}}>Back to Home →</Link>
      </div>
    </div>
  )
}
