      ...
      <main style={{ maxWidth: '760px', margin: '0 auto', padding: '56px 40px 80px' }}>
        <div style={{ marginBottom: '48px' }}>
          ...
          <p style={{ fontSize: '16px', color: 'var(--t2)', lineHeight: 1.8 }}>
            TheFundedDiaries was built by a trader who was tired of biased prop firm comparison sites. Every other platform seemed to promote whoever paid the most — making it impossible to know which firm was genuinely the best.
          </p>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          {[
            { title: 'Our Mission', content: `To be the most transparent and trustworthy prop firm comparison platform. We verify every rule, every challenge, and every payout claim — and we show you exactly what commission we earn from each firm. No hidden agendas.` },
            ...
            { title: 'Contact', content: `Built and maintained by Cristian · hello@thefundeddiaries.com · thefundeddiaries.com` },
          ].map(s => (
