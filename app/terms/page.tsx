...
export default function TermsPage() {
  const sections = [
    { title: '1. Acceptance of Terms', content: `By accessing TheFundedDiaries.com, you agree to these Terms of Service. If you do not agree, please do not use our platform. We reserve the right to update these terms at any time — continued use constitutes acceptance.` },
    ...
    { title: '7. Intellectual Property', content: `All content on TheFundedDiaries — including text, graphics, logos, and code — is owned by TheFundedDiaries or its licensors and protected by copyright law. You may not reproduce or distribute our content without written permission.` },
