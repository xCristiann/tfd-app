      ...
      <main>
        ...
        <section style={{ padding: '80px 0 56px', textAlign: 'center' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 40px' }}>
                  ...
                  >
                    ...
                    {p.isNew && (
                      <span style={{
                        ...
                        background: active ? 'rgba(255,255,255,0.25)' : 'rgba(167,139,250,0.2)',
            ...
            {/* SEARCH */}
            <div style={{ display: 'flex', gap: '8px', maxWidth: '540px', margin: '0 auto 60px', background: 'var(--bg1)', border: '1px solid var(--border2)', borderRadius: '14px', padding: '6px 6px 6px 20px' }}>
              <input
                type="text"
                placeholder={`Search ${market === 'all' ? 'all firms' : market + ' firms'}...`}
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 40px' }}>
          ...
          {/* ─── STATS ─── */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', borderRadius: '16px', overflow: 'hidden', border: '1px solid var(--border)', marginBottom: '64px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '24px' }}>
            <div>
              ...
              <div style={{ fontSize: '14px', color: 'var(--t2)' }}>
                {loading ? 'Loading...' : `${filtered.length} firms shown · click any card for full details`}
              </div>
            </div>
          ...
          {loading ? (
            ...
            <div style={{ textAlign: 'center', padding: '80px', color: 'var(--t2)' }}>
              <div style={{ fontSize: '32px', marginBottom: '12px' }}>🔍</div>
              No {market} firms yet — check back soon.
            </div>
          ) : (
          ...
          <div style={{ textAlign: 'center', marginBottom: '80px' }}>
            <Link
              ...
              style={{
                ...
                background: 'var(--bg1)', textDecoration: 'none', transition: 'all .2s'
              }}
            >
              View all {market === 'all' ? '' : market + ' '}firms →
            </Link>
          </div>
          ...
          <div style={{ borderRadius: '16px', padding: '60px 56px', marginBottom: '80px', position: 'relative', overflow: 'hidden', background: 'var(--bg1)', border: '1px solid var(--border2)', textAlign: 'center' }}>
            ...
            <Link
              href="/calculator"
              style={{ display: 'inline-block', padding: '15px 34px', borderRadius: '12px', fontSize: '15px', fontWeight: 800, color: '#04120c', background: 'linear-gradient(135deg,var(--teal),#4fffcc)', textDecoration: 'none', boxShadow: '0 0 40px var(--teal-glow)', position: 'relative' }}
            >
