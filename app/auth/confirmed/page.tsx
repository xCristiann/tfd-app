    ...
    <>
      ...
      <main style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px' }}>
        <div style={{ maxWidth: '460px', width: '100%', textAlign: 'center' }}>
          ...
          <Link href="/" style={{ display: 'inline-block', padding: '13px 28px', borderRadius: '10px', fontSize: '15px', fontWeight: 800, color: '#04120c', background: 'var(--teal)', textDecoration: 'none', boxShadow: '0 0 24px var(--teal-glow)' }}>
            Start Exploring →
          </Link>
          <div style={{ marginTop: '16px' }}>
            <Link href="/coins" style={{ fontSize: '13px', color: 'var(--teal)', textDecoration: 'none' }}>
              🪙 Check your welcome coins →
            </Link>
          </div>
        </div>
      </main>
