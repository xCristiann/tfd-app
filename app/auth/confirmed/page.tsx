  ...
  if (error) {
    return (
      <div style={{ maxWidth: '460px', width: '100%', textAlign: 'center' }}>
        <div style={{ width: '64px', height: '64px', borderRadius: '18px', background: 'rgba(248,113,113,0.15)', border: '1px solid rgba(248,113,113,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px', fontSize: '28px' }}>✗</div>
        ...
        <div style={{ marginTop: '12px' }}>
          <Link href="/auth/login" style={{ fontSize: '13px', color: 'var(--t3)', textDecoration: 'none' }}>Already confirmed? Sign in →</Link>
        </div>
      </div>
    )
  }
